...
plt.errorbar(aliceTOT_phi,aliceTOT_bf,aliceTOT_errors,markersize='10',linestyle='None',marker='*',color='k',label='$\cdot$ALICE (prel)')
...
plt.savefig('bf_phi_KK.pdf',format='pdf')
os.system('open -a Preview bf_phi_KK.pdf')
#os.system('okular bf_phi_KK.pdf &')
#plt.show()
quit()
