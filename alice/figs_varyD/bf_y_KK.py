...
chargesdata = np.loadtxt('../alice_D1/model_output/default_sum/'+centrality+'/results_alice/'+chargepair+'/bf_y.dat',skiprows=0,unpack=True)
x=chargesdata[0]
y1=chargesdata[1]
y_D1=efficiency*y1

chargesdata_D0_5 = np.loadtxt('../alice_D0.5/model_output/default_sum/'+centrality+'/results_alice/'+chargepair+'/bf_y.dat',skiprows=0,unpack=True)
x_D4=chargesdata_D0_5[0]
y1=chargesdata_D0_5[1]
y_D0_5=efficiency*y1

filename='../alice_D2/model_output/default_sum/'+centrality+'/results_alice/'+chargepair+'/bf_y.dat'
chargesdata_D2 = np.loadtxt(filename,skiprows=0,unpack=True)
x_D4=chargesdata_D2[0]
y1=chargesdata_D2[1]
y_D2=efficiency*y1

filename='../alice_D4/model_output/default_sum/'+centrality+'/results_alice/'+chargepair+'/bf_y.dat'
...
cascadedata = np.loadtxt('../alice_fromcascade/model_output/default_sum/'+centrality+'/results_alice/'+chargepair+'/bf_y.dat',skiprows=0,unpack=True)
xc=cascadedata[0]
yc1=cascadedata[1]
yc=efficiency*yc1
...
alicedata=np.loadtxt('alicedata/BF_dy_KK_C0_10_ALICE.dat',skiprows=0,unpack=True)
alice_y=alicedata[0]
