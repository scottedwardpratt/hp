...
for ipanel in range (0,Npanels):
  ...
  if ipanel == 3:
    ...
    ax.annotate('(c) $KK$',xy=(1.9,ymax-0.18*(ymax-ymin)), family='serif', size=24,horizontalalignment='right') 
  ...
  if ipanel == 4:
    ...
    ax.annotate('(b) ${Kp}$',xy=(1.9,ymax-0.18*(ymax-ymin)), family='serif', size=24,horizontalalignment='right')
  ...
  if ipanel == 5:
    ...
    ax.set_yticklabels(np.arange(-1,1,0.05), minor=False, family='serif', size=14)
    ax.set_yticks(np.arange(-1,1,0.025), minor=True)
    ax.annotate('(a) $pp$',xy=(1.9,ymax-0.18*(ymax-ymin)), family='serif', size=24,horizontalalignment='right')
...
filename='generalcrap_y_'+centrality+'.pdf'
