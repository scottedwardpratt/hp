...
CHydroBalance::CHydroBalance(string parfilename,string qualifier_set){
	...
	chif=arma::zeros(3,3);
	chitot=arma::zeros(3,3);
	chitothyper=arma::zeros(3,3);
