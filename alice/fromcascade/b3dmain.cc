...
int main(int argc, char *argv[]){
	...
	int ievent,iqual,nevents,ievent0,ieventf;
	char run_name_cstr[100];
	int irun=atoi(argv[1]);
	sprintf(run_name_cstr,"default_%d",irun);
	string run_name=run_name_cstr;
	...
	nevents=b3d->parmap.getI("B3D_NEVENTSMAX",25);
	ievent0=irun*nevents;
	ieventf=ievent0+nevents;
